...
New-ItemProperty -Path "$registryPath\$shellPath\$registryName" -Name $name -Value 'C:\Program Files\Microsoft VS Code\Code.exe" "%1"'  -PropertyType ExpandString -Force | Out-Null
